...
class Contact extends Component 
{
   constructor(props)
   {
    ...
    validate=(firstname,lastname,telnum)=>{
        ...
        errors.firstname='firtname should be greater than 3 letters';
        else if(this.state.touched.firstname && firstname.length>10)
        errors.firstname='lenth of firstname should be less than 10';
        if (this.state.touched.lastname && lastname.length<3)
        errors.lastname='lastname should be greater than 3 letters';
        else if(this.state.touched.lastname && lastname.length>10)
        errors.lastname='lenth of lastname should be less than 10';
        const reg=/^\d+$/;
        if (this.state.touched.telnum && !reg.test(telnum) )
        errors.telnum='it should be only numbers. ';
        else if(this.state.touched.telnum && telnum.length<10)
        errors.telnum='it shoud be 10';
